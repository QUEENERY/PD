...
<body>
  <div class="container mt-5">
    <div class="row">
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
        ...
        <div class="card">
          <div class="card-body">
            <img src="assets/img/login.jpg" alt="logo" width="200" class="d-block mx-auto img-fluid">
            <h4 class="text-center">SELAMAT DATANG DI PROPERTI RUMAH</h4>
  ...
  if(isset($_POST['login'])) {
    ...
    if($username === "properti" && $password === "properti" || $username === "admin" && $password === "admin" ) {
        ...
        echo"<script>alert('gagal login,ulangi!')</script>";
    }
}
